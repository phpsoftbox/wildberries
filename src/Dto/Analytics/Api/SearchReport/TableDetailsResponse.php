...
final readonly class TableDetailsResponse implements WildberriesDtoInterface
{
    /**
     * @param list<TableProductItem> $products
    ...
    {
        return new self(
            products: WildberriesDtoValue::objectList($payload['products'] ?? null, TableProductItem::class),
