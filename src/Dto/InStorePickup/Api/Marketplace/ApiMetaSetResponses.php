...
final readonly class ApiMetaSetResponses implements WildberriesDtoInterface
{
    /**
     * @param array<array-key, mixed> $requestId
     * @param list<ApiMetaSetResponse> $results
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            results: WildberriesDtoValue::objectList($payload['results'] ?? null, ApiMetaSetResponse::class),
