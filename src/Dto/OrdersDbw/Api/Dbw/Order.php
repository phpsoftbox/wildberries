...
final readonly class Order implements WildberriesDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            extra: WildberriesDtoValue::extra($payload, ['address', 'options', 'orderUid', 'groupId', 'article', 'colorCode', 'rid', 'createdAt', 'skus', 'id', 'warehouseId', 'nmId', 'chrtId', 'price', 'convertedPrice', 'currencyCode', 'convertedCurrencyCode', 'cargoType', 'comment', 'isZeroOrder']),
        );
    }
}
