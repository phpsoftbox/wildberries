...
final readonly class StatsBlok2 implements WildberriesDtoInterface
{
    /**
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            dailyStats: WildberriesDtoValue::object($payload['daily_stats'] ?? null, DailyStats2::class),
